 ...
 * 30 April 2018
 * 
 * Third draft of the sensing part (not including swerving)
...
const int ECHO_PINS[] = {12};       // List of "output" pins of all ultrasonic sensors
const int TRIG_PINS[] = {13};            // Trigger/switch/input pin for ultrasonic sensor
